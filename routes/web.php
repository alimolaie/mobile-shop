...
Route::group(['prefix' => 'admin'] , function (){
    ...
    Route::get('/product/setting', [PostController::class , 'setting'])->middleware(['permission:همه محصولات']);
    Route::post('/product/setting', [PostController::class , 'settingStore'])->middleware(['permission:همه محصولات']);
    ...
    Route::get('/product/{product}/seo', [PostController::class , 'seo'])->middleware(['permission:همه محصولات']);
    Route::post('/product/{product}/seo', [PostController::class , 'seoLink'])->middleware(['permission:همه محصولات']);
    ...
    Route::post('/product/get-keyword', [PostController::class , 'getKeyword'])->middleware(['permission:افزودن محصول']);
    ...
    Route::get('/comment/create',  [App\Http\Controllers\Admin\CommentController::class, 'create'])->middleware(['permission:دیدگاه']);
    Route::post('/comment/create',  [App\Http\Controllers\Admin\CommentController::class, 'store'])->middleware(['permission:دیدگاه']);
    ...
    Route::delete('/loan/{loan}/delete', [LoanController::class , 'delete'])->middleware(['permission:وام']);
    ...
    Route::get('/pay/{pay}', [PayController::class , 'edit'])->middleware(['permission:ویرایش سفارشات']);
    Route::put('/pay/{pay}', [PayController::class , 'update'])->middleware(['permission:ویرایش سفارشات']);
    Route::post('/add-pay/{pay}', [PayController::class , 'addPay'])->middleware(['permission:ویرایش سفارشات']);
    Route::put('/delete-pay/{pay_meta}', [PayController::class , 'deleteMeta'])->middleware(['permission:ویرایش سفارشات']);
    Route::put('/update-pay/{pay}', [PayController::class , 'updatePaySnap'])->middleware(['permission:ویرایش سفارشات']);
...
Route::group(['prefix' => '/'] , function (){
    ...
    Route::post('/close-chat', [\App\Http\Controllers\Home\TicketController::class , 'closeChat']);
    Route::post('/get-online-ticket', [\App\Http\Controllers\Home\TicketController::class , 'onlineTicket']);
    ...
    Route::get('/download/{ProductSlug}/download', [SingleController::class , 'downloadFile']);
    ...
    Route::post('/change-snap', [CartController::class , 'changeSnap']);
    ...
    Route::match(['get','post'],'/order/snappay',  [ShopController::class, 'snappay']);
    /// fast
    Route::match(['get','post'],'/fast',  [ShopController::class, 'fast']);
    Route::match(['get','post'],'/fast-shop',  [ShopController::class, 'fast_order']);
    /// spot
    ...
    Route::post('/send-convert',  [ProfileController::class, 'convertScore'])->middleware(['web', 'auth']);
    ...
    Route::post('/get-collect-gift',  [ProfileController::class, 'getCollect'])->middleware(['web', 'auth']);
    Route::get('/offline',  [IndexController::class, 'offline']);
    Route::post('/profile/ticket/get-ticket',  [\App\Http\Controllers\Home\TicketController::class, 'getChatTicket'])->middleware(['web', 'auth']);
    Route::post('/profile/ticket/send-ticket',  [\App\Http\Controllers\Home\TicketController::class, 'sendChat'])->middleware(['web', 'auth']);
