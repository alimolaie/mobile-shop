...
class SettingController extends Controller
{
    ...
    public function manageIndex(){
        ...
        $deliverStatus = Setting::where('key' , 'deliverStatus')->pluck('value')->first();
        $sellerStatus = Setting::where('key' , 'sellerStatus')->pluck('value')->first();
        $chatStatus = Setting::where('key' , 'chatStatus')->pluck('value')->first();
        $ticketStatus = Setting::where('key' , 'ticketStatus')->pluck('value')->first();
        ...
        $preLoaderStatus = Setting::where('key' , 'preLoaderStatus')->pluck('value')->first();
        $backIndex = Setting::where('key' , 'backIndex')->pluck('value')->first();
        $scoreDay = Setting::where('key' , 'scoreDay')->pluck('value')->first();
        return view('admin.setting.manage' , compact('name','title','scoreDay','textFloatEn','newRedirect','backIndex','preLoaderStatus','redirectStatus','chatStatus','ticketStatus','deliverStatus','sellerStatus','languageStatus','darkStatus','textFloatAr','textFloatTr','aboutEn','aboutAr','aboutTr','addressEn','addressAr','addressTr','nameAr','titleAr','nameEn','titleEn','nameTr','titleTr','maxGift','tax','captchaType','google','captchaStatus','github','textFloat','headerColor','holidays','giftDis','sideColor','minifySource','cooperationStatus','cooperationPercent','descriptionPopUp','buttonPopUp','imagePopUp','titlePopUp','addressPopUp','popUpStatus','heightHeader','imageHeader','linkHeader','adHeaderStatus','logo','about','address','email','fanavari','etemad','number','facebook','instagram','twitter','telegram','productId'));
    }
    ...
    public function manageUpdate(Request $request){
        ...
        $deliverStatus = $request->deliverStatus;
        ...
        $redirectStatus = $request->redirectStatus;
        $preLoaderStatus = $request->preLoaderStatus;
    ...
    public function themeIndex(){
        ...
        $floatDesign = Setting::where('key' , 'floatDesign')->pluck('value')->first();
        $font = Setting::where('key' , 'font')->pluck('value')->first();
        return view('admin.setting.theme' , compact('greenColorLight','redColorLight','floatDesign','singleDesign','font','headerDesign','footerDesign','loginDesign','backColorLight1','headerColorLight','headerColor2Light','widgetColorLight','singleColorLight','greenColorDark','redColorDark','backColorDark1','headerColorDark','headerColor2Dark','widgetColorDark','singleColorDark'));
    }
    ...
    public function themeUpdate(Request $request){
        if($request->demo >= 1){
            ...
            if($request->demo == 5) {
                $demo = json_decode('[{"id":51,"name":"\u062c\u0634\u0646\u0648\u0627\u0631\u0647","title":"\u062c\u0634\u0646\u0648\u0627\u0631\u0647 \u0641\u0631\u0648\u0634 \u0645\u062d\u0635\u0648\u0644\u0627\u062a","more":null,"number":"0","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"2024-08-19 14:02:52","responsive":"0","cats":"[]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2023-11-20T10:31:38.000000Z","updated_at":"2023-11-20T10:37:55.000000Z"},{"id":48,"name":"\u0634\u06af\u0641\u062a \u0627\u0646\u06af\u06cc\u0632","title":"\u062c\u062f\u06cc\u062f \u062a\u0631\u06cc\u0646 \u0645\u062d\u0635\u0648\u0644\u0627\u062a","more":"\u062c\u062f\u06cc\u062f \u062a\u0631\u06cc\u0646 \u0645\u062d\u0635\u0648\u0644\u0627\u062a","number":"1","description":"\u062c\u062f\u06cc\u062f \u062a\u0631\u06cc\u0646 \u0645\u062d\u0635\u0648\u0644\u0627\u062a","background":"#4843af","slug":"\u062c\u062f\u06cc\u062f-\u0645\u062d\u0635\u0648\u0644","background2":"https:\/\/rayganapp.ir\/upload\/image\/2024\/sug.png","count":"7","sort":"0","type":"3","status":"1","brands":"[]","move":"1","height":"16","responsive":"0","cats":"[]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2023-11-20T10:20:04.000000Z","updated_at":"2023-11-20T10:37:55.000000Z"},{"id":52,"name":"\u062a\u0628\u0644\u06cc\u063a \u0627\u0633\u0644\u0627\u06cc\u062f\u0631\u06cc","title":null,"more":null,"number":"2","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[]","ads2":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/qq3.webp\",\"address\":\"\/\"}]","ads3":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/qq4.jpg\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/qq5.jpg\",\"address\":\"\/\"}]","created_at":"2023-11-20T10:36:39.000000Z","updated_at":"2023-11-20T10:41:19.000000Z"},{"id":49,"name":"\u0634\u06af\u0641\u062a \u0627\u0646\u06af\u06cc\u0632","title":"\u06a9\u0627\u0644\u0627\u0647\u0627\u06cc \u062f\u06cc\u062c\u06cc\u062a\u0627\u0644","more":"\u06a9\u0627\u0644\u0627\u0647\u0627\u06cc \u062f\u06cc\u062c\u06cc\u062a\u0627\u0644","number":"3","description":"\u06a9\u0627\u0644\u0627\u0647\u0627\u06cc \u062f\u06cc\u062c\u06cc\u062a\u0627\u0644","background":"#ed4005","slug":"\u0645\u062d\u0635\u0648\u0644-\u062f\u06cc\u062c\u06cc\u062a\u0627\u0644","background2":"https:\/\/rayganapp.ir\/upload\/image\/2024\/sug2.png","count":"7","sort":"1","type":"3","status":"1","brands":"[]","move":"1","height":"16","responsive":"0","cats":"[\"27\"]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2023-11-20T10:20:04.000000Z","updated_at":"2023-11-20T10:37:55.000000Z"},{"id":53,"name":"\u062a\u0628\u0644\u06cc\u063a \u0633\u0627\u062f\u0647","title":null,"more":null,"number":"4","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/qq1.webp\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/qq2.webp\",\"address\":\"\/\"}]","ads2":"[]","ads3":"[]","created_at":"2023-11-20T10:37:51.000000Z","updated_at":"2023-11-20T10:39:33.000000Z"},{"id":50,"name":"\u0634\u06af\u0641\u062a \u0627\u0646\u06af\u06cc\u0632","title":"\u0645\u062f \u0648 \u067e\u0648\u0634\u0627\u06a9","more":"\u0645\u062f \u0648 \u067e\u0648\u0634\u0627\u06a9","number":"5","description":"\u0645\u062f \u0648 \u067e\u0648\u0634\u0627\u06a9","background":"#35d31f","slug":"\u0645\u062f-\u0645\u062d\u0635\u0648\u0644","background2":"https:\/\/rayganapp.ir\/upload\/image\/2024\/sug3.webp","count":"7","sort":"1","type":"3","status":"1","brands":"[]","move":"1","height":"16","responsive":"0","cats":"[\"37\"]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2023-11-20T10:20:04.000000Z","updated_at":"2023-11-20T10:37:55.000000Z"}]');
            }
            if($request->demo == 6) {
                $demo = json_decode('[{"id":48,"name":"\u062a\u0628\u0644\u06cc\u063a \u0633\u0627\u062f\u0647","title":null,"more":null,"number":"0","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/hs.png\",\"address\":\"\/\"}]","ads2":"[]","ads3":"[]","created_at":"2024-01-17T16:46:30.000000Z","updated_at":"2024-01-17T17:27:16.000000Z"},{"id":49,"name":"\u0634\u06af\u0641\u062a \u0627\u0646\u06af\u06cc\u0632","title":"\u062c\u062f\u06cc\u062f \u062a\u0631\u06cc\u0646 \u0645\u062d\u0635\u0648\u0644\u0627\u062a","more":"\u0645\u062d\u0635\u0648\u0644\u0627\u062a \u0648\u06cc\u0698\u0647","number":"1","description":"\u0645\u062d\u0635\u0648\u0644\u0627\u062a \u0645\u0627","background":"transparent","slug":"\u0645\u062d\u0635\u0648\u0644\u0627\u062a1","background2":"https:\/\/rayganapp.ir\/upload\/image\/2024\/sug3.webp","count":"8","sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"15","responsive":"0","cats":"[]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2024-01-17T16:53:53.000000Z","updated_at":"2024-01-17T17:27:16.000000Z"},{"id":50,"name":"\u062f\u0633\u062a\u0647 \u0628\u0646\u062f\u06cc 2","title":"\u062f\u0633\u062a\u0647 \u0628\u0646\u062f\u06cc \u0647\u0627\u06cc \u0648\u06cc\u0698\u0647","more":null,"number":"2","description":null,"background":"#e0ecf2","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[\"27\",\"30\",\"32\",\"33\",\"38\",\"50\",\"53\",\"55\",\"59\"]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2024-01-17T17:02:06.000000Z","updated_at":"2024-01-17T17:27:16.000000Z"},{"id":52,"name":"\u0644\u06cc\u0633\u062a\u06cc","title":"\u0645\u062d\u0635\u0648\u0644\u0627\u062a \u0648\u06cc\u0698\u0647 \u0645\u0627","more":"\u0645\u0634\u0627\u0647\u062f\u0647 \u0647\u0645\u0647","number":"3","description":null,"background":"#000000","slug":"\u0628\u0647\u062a\u0631\u06cc\u06461","background2":null,"count":"10","sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"12","responsive":"0","cats":"[]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2024-01-17T17:08:20.000000Z","updated_at":"2024-01-17T17:28:54.000000Z"},{"id":51,"name":"\u062f\u0631\u0628\u0627\u0631\u0647 \u0645\u0627","title":"\u0622\u0646\u0686\u0647 \u062f\u0631\u0628\u0627\u0631\u0647 \u0645\u0627 \u0628\u0627\u06cc\u062f \u0628\u062f\u0627\u0646\u06cc\u062f","more":null,"number":"4","description":"\u0644\u0648\u0631\u0645 \u0627\u06cc\u067e\u0633\u0648\u0645 \u0645\u062a\u0646 \u0633\u0627\u062e\u062a\u06af\u06cc \u0628\u0627 \u062a\u0648\u0644\u06cc\u062f \u0633\u0627\u062f\u06af\u06cc \u0646\u0627\u0645\u0641\u0647\u0648\u0645 \u0627\u0632 \u0635\u0646\u0639\u062a \u0686\u0627\u067e \u0648 \u0628\u0627 \u0627\u0633\u062a\u0641\u0627\u062f\u0647 \u0627\u0632 \u0637\u0631\u0627\u062d\u0627\u0646 \u06af\u0631\u0627\u0641\u06cc\u06a9 \u0627\u0633\u062a. \u0686\u0627\u067e\u06af\u0631\u0647\u0627 \u0648 \u0645\u062a\u0648\u0646 \u0628\u0644\u06a9\u0647 \u0631\u0648\u0632\u0646\u0627\u0645\u0647 \u0648 \u0645\u062c\u0644\u0647 \u062f\u0631 \u0633\u062a\u0648\u0646 \u0648 \u0633\u0637\u0631\u0622\u0646\u0686\u0646\u0627\u0646 \u06a9\u0647 \u0644\u0627\u0632\u0645 \u0627\u0633\u062a \u0648 \u0628\u0631\u0627\u06cc \u0634\u0631\u0627\u06cc\u0637 \u0641\u0639\u0644\u06cc \u062a\u06a9\u0646\u0648\u0644\u0648\u0698\u06cc \u0645\u0648\u0631\u062f \u0646\u06cc\u0627\u0632 \u0648 \u06a9\u0627\u0631\u0628\u0631\u062f\u0647\u0627\u06cc \u0645\u062a\u0646\u0648\u0639 \u0628\u0627 \u0647\u062f\u0641 \u0628\u0647\u0628\u0648\u062f \u0627\u0628\u0632\u0627\u0631\u0647\u0627\u06cc \u06a9\u0627\u0631\u0628\u0631\u062f\u06cc \u0645\u06cc \u0628\u0627\u0634\u062f. \u06a9\u062a\u0627\u0628\u0647\u0627\u06cc \u0632\u06cc\u0627\u062f\u06cc \u062f\u0631 \u0634\u0635\u062a \u0648 \u0633\u0647 \u062f\u0631\u0635\u062f \u06af\u0630\u0634\u062a\u0647\u060c \u062d\u0627\u0644 \u0648 \u0622\u06cc\u0646\u062f\u0647 \u0634\u0646\u0627\u062e\u062a \u0641\u0631\u0627\u0648\u0627\u0646 \u062c\u0627\u0645\u0639\u0647 \u0648 \u0645\u062a\u062e\u0635\u0635\u0627\u0646 \u0631\u0627 \u0645\u06cc \u0637\u0644\u0628\u062f \u062a\u0627 \u0628\u0627 \u0646\u0631\u0645 \u0627\u0641\u0632\u0627\u0631\u0647\u0627 \u0634\u0646\u0627\u062e\u062a \u0628\u06cc\u0634\u062a\u0631\u06cc \u0631\u0627 \u0628\u0631\u0627\u06cc \u0637\u0631\u0627\u062d\u0627\u0646 \u0631\u0627\u06cc\u0627\u0646\u0647 \u0627\u06cc \u0639\u0644\u06cc \u0627\u0644\u062e\u0635\u0648\u0635 \u0637\u0631\u0627\u062d\u0627\u0646 \u062e\u0644\u0627\u0642\u06cc \u0648 \u0641\u0631\u0647\u0646\u06af \u067e\u06cc\u0634\u0631\u0648 \u062f\u0631 \u0632\u0628\u0627\u0646 \u0641\u0627\u0631\u0633\u06cc \u0627\u06cc\u062c\u0627\u062f \u06a9\u0631\u062f. \u062f\u0631 \u0627\u06cc\u0646 \u0635\u0648\u0631\u062a \u0645\u06cc \u062a\u0648\u0627\u0646 \u0627\u0645\u06cc\u062f \u062f\u0627\u0634\u062a \u06a9\u0647 \u062a\u0645\u0627\u0645 \u0648 \u062f\u0634\u0648\u0627\u0631\u06cc \u0645\u0648\u062c\u0648\u062f \u062f\u0631 \u0627\u0631\u0627\u0626\u0647 \u0631\u0627\u0647\u06a9\u0627\u0631\u0647\u0627 \u0648 \u0634\u0631\u0627\u06cc\u0637 \u0633\u062e\u062a \u062a\u0627\u06cc\u067e \u0628\u0647 \u067e\u0627\u06cc\u0627\u0646 \u0631\u0633\u062f \u0648\u0632\u0645\u0627\u0646 \u0645\u0648\u0631\u062f \u0646\u06cc\u0627\u0632 \u0634\u0627\u0645\u0644 \u062d\u0631\u0648\u0641\u0686\u06cc\u0646\u06cc \u062f\u0633\u062a\u0627\u0648\u0631\u062f\u0647\u0627\u06cc \u0627\u0635\u0644\u06cc \u0648 \u062c\u0648\u0627\u0628\u06af\u0648\u06cc \u0633\u0648\u0627\u0644\u0627\u062a \u067e\u06cc\u0648\u0633\u062a\u0647 \u0627\u0647\u0644 \u062f\u0646\u06cc\u0627\u06cc \u0645\u0648\u062c\u0648\u062f \u0637\u0631\u0627\u062d\u06cc \u0627\u0633\u0627\u0633\u0627 \u0645\u0648\u0631\u062f \u0627\u0633\u062a\u0641\u0627\u062f\u0647 \u0642\u0631\u0627\u0631 \u06af\u06cc\u0631\u062f.","background":"#e0ecf2","slug":null,"background2":"https:\/\/rayganapp.ir\/upload\/image\/2024\/mn.webp","count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[]","ads2":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/ss1.jpg\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/ss2.gif\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/ss3.webp\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/ss4.webp\",\"address\":\"\/\"}]","ads3":"[]","created_at":"2024-01-17T17:07:05.000000Z","updated_at":"2024-01-17T17:27:16.000000Z"},{"id":53,"name":"\u0628\u0646\u0631 \u0628\u0627 \u0639\u0646\u0648\u0627\u0646","title":"\u0628\u0631\u0646\u062f \u0647\u0627\u06cc \u0645\u0627","more":null,"number":"5","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/ff1.png\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/ff2.png\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/ff3.png\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/ff4.png\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/ff5.png\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/ff6.png\",\"address\":\"\/\"}]","ads2":"[]","ads3":"[]","created_at":"2024-01-17T17:26:43.000000Z","updated_at":"2024-01-17T17:27:53.000000Z"}]');
            }
            if($request->demo == 7) {
                $demo = json_decode('[{"id":2,"name":"\u062a\u0628\u0644\u06cc\u063a \u0633\u0627\u062f\u0647","title":null,"more":null,"number":"0","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/mm.gif\",\"address\":\"\/\"}]","ads2":"[]","ads3":"[]","created_at":"2024-01-21T13:55:46.000000Z","updated_at":"2024-01-21T14:48:20.000000Z"},{"id":3,"name":"\u0645\u062d\u0635\u0648\u0644\u0627\u062a \u0627\u0641\u0642\u06cc \u0628\u0627 \u062f\u0633\u062a\u0647 \u0628\u0646\u062f\u06cc","title":"\u062c\u062f\u06cc\u062f \u062a\u0631\u06cc\u0646 \u0645\u062d\u0635\u0648\u0644\u0627\u062a","more":null,"number":"1","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[\"28\",\"29\",\"31\",\"32\",\"33\"]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2024-01-21T13:57:02.000000Z","updated_at":"2024-01-21T14:24:58.000000Z"},{"id":1,"name":"\u062a\u0628\u0644\u06cc\u063a \u0627\u0633\u0644\u0627\u06cc\u062f\u0631\u06cc","title":null,"more":null,"number":"2","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[]","ads2":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/mm3.jpg\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/mm3.jpg\",\"address\":\"\/\"}]","ads3":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/mm4.jpg\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/mm5.jpg\",\"address\":\"\/\"}]","created_at":"2024-01-21T13:48:04.000000Z","updated_at":"2024-01-21T14:49:58.000000Z"},{"id":4,"name":"\u0645\u062d\u0635\u0648\u0644\u0627\u062a \u0628\u0627 \u0641\u06cc\u0644\u062a\u0631","title":"\u0627\u0632 \u0645\u062d\u0635\u0648\u0644\u0627\u062a \u0645\u0627 \u062f\u06cc\u062f\u0646 \u0641\u0631\u0645\u0627\u06cc\u06cc\u062f","more":null,"number":"3","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[\"27\",\"37\",\"53\"]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2024-01-21T13:59:39.000000Z","updated_at":"2024-01-21T14:24:58.000000Z"},{"id":5,"name":"\u0627\u0633\u0644\u0627\u06cc\u062f\u0631 \u0628\u0632\u0631\u06af","title":null,"more":null,"number":"4","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/mm6.gif\",\"address\":\"\/\"}]","ads2":"[]","ads3":"[]","created_at":"2024-01-21T14:07:58.000000Z","updated_at":"2024-01-21T14:50:44.000000Z"},{"id":7,"name":"\u0628\u0647\u062a\u0631\u06cc\u0646 \u0647\u0627","title":"\u0628\u0647\u062a\u0631\u06cc\u0646 \u0647\u0627","more":null,"number":"5","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2024-01-21T14:24:52.000000Z","updated_at":"2024-01-21T14:24:58.000000Z"},{"id":6,"name":"\u062e\u0628\u0631","title":"\u062c\u062f\u06cc\u062f \u062a\u0631\u06cc\u0646 \u0627\u062e\u0628\u0627\u0631","more":null,"number":"6","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2024-01-21T14:09:23.000000Z","updated_at":"2024-01-21T14:24:58.000000Z"}]');
            }
            if($request->demo == 8) {
                $demo = json_decode('[{"id":8,"name":"\u062a\u0628\u0644\u06cc\u063a \u0633\u0627\u062f\u0647","title":null,"more":null,"number":"0","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/jj1.webp\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/jj2.webp\",\"address\":\"\/\"}]","ads2":"[]","ads3":"[]","created_at":"2024-06-21T17:38:00.000000Z","updated_at":"2024-06-21T17:38:00.000000Z"},{"id":3,"name":"\u0645\u062d\u0635\u0648\u0644 \u062a\u0635\u0648\u06cc\u0631 \u0628\u0627\u0644\u0627","title":"\u062c\u062f\u06cc\u062f \u062a\u0631\u06cc\u0646 \u0645\u062d\u0635\u0648\u0644\u0627\u062a","more":"\u0647\u0645\u06cc\u0646 \u062d\u0627\u0644\u0627 \u0645\u062d\u0635\u0648\u0644\u062a\u0627\u0646 \u0631\u0627 \u062a\u0647\u06cc\u0647 \u06a9\u0646\u06cc\u062f","number":"1","description":null,"background":"#000000","slug":"new","background2":"https:\/\/ninetheme.com\/themes\/zank2\/wp-content\/uploads\/elementor\/thumbs\/23-1-1-q9ce9jasrvxhpske4w3bdk4nmtw7i3wcu3ahwe1sps.png","count":"10","sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"15","responsive":"0","cats":"[\"28\",\"29\",\"31\",\"32\",\"33\"]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2024-01-21T13:57:02.000000Z","updated_at":"2024-01-21T14:24:58.000000Z"},{"id":1,"name":"\u062a\u0628\u0644\u06cc\u063a \u0627\u0633\u0644\u0627\u06cc\u062f\u0631\u06cc","title":null,"more":null,"number":"2","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[]","ads2":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/mm3.jpg\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/mm3.jpg\",\"address\":\"\/\"}]","ads3":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/mm4.jpg\",\"address\":\"\/\"},{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/mm5.jpg\",\"address\":\"\/\"}]","created_at":"2024-01-21T13:48:04.000000Z","updated_at":"2024-01-21T14:49:58.000000Z"},{"id":4,"name":"\u0645\u062d\u0635\u0648\u0644 \u062a\u0635\u0648\u06cc\u0631 \u0686\u067e","title":"\u0627\u0631\u0632\u0627\u0646\u062a\u0631\u06cc\u0646 \u0647\u0627 \u0627\u06cc\u0646\u062c\u0627\u0633\u062a","more":"\u0627\u0632 \u0645\u062d\u0635\u0648\u0644\u0627\u062a \u0645\u0627 \u062f\u06cc\u062f\u0646 \u0641\u0631\u0645\u0627\u06cc\u06cc\u062f","number":"3","description":null,"background":"#000000","slug":"cheap","background2":"https:\/\/ninetheme.com\/themes\/zank2\/wp-content\/uploads\/2023\/01\/12-2-1.png","count":"8","sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"15","responsive":"0","cats":"[\"27\",\"37\",\"53\"]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2024-01-21T13:59:39.000000Z","updated_at":"2024-01-21T14:24:58.000000Z"},{"id":5,"name":"\u062a\u0628\u0644\u06cc\u063a \u0633\u0627\u062f\u0647","title":null,"more":null,"number":"4","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[{\"image\":\"https:\/\/rayganapp.ir\/upload\/image\/2024\/mm6.gif\",\"address\":\"\/\"}]","ads2":"[]","ads3":"[]","created_at":"2024-01-21T14:07:58.000000Z","updated_at":"2024-01-21T14:50:44.000000Z"},{"id":6,"name":"\u062e\u0628\u06312","title":"\u062c\u062f\u06cc\u062f \u062a\u0631\u06cc\u0646 \u0627\u062e\u0628\u0627\u0631","more":null,"number":"6","description":null,"background":"#000000","slug":null,"background2":null,"count":null,"sort":"0","type":"3","status":"1","brands":"[]","move":"0","height":"20","responsive":"0","cats":"[]","language":"fa","ads1":"[]","ads2":"[]","ads3":"[]","created_at":"2024-01-21T14:09:23.000000Z","updated_at":"2024-01-21T14:24:58.000000Z"}]');
            }
        ...
        $floatDesign = $request->floatDesign;
        $font = $request->font;
        $array = [
    ...
    public function messageIndex(){
        ...
        $messageTicketManager = Setting::where('key' , 'messageTicketManager')->pluck('value')->first();
        ...
        return view('admin.setting.message' , compact('messageAuth','messageTicketManager','messageTicket','messageCounseling','messageTrack','messageRegister','messageStatus0','messageStatus1','messageStatus2','messageStatus3','userSms','passSms','kaveKey','userFaraz','passFaraz','numberFaraz','typeSms','messageSuccess','messageSuggest','messageCancel','messageBack','messageManager'));
    }
    ...
    public function messageUpdate(Request $request){
        ...
        $messageTicketManager = $request->messageTicketManager;
        $messageTicket = $request->messageTicket;
        ...
        $array = [
            ...
            'messageTicketManager' =>$messageTicketManager,
    ...
    public function paymentIndex(){
        ...
        $userSnap = Setting::where('key' , 'userSnap')->pluck('value')->first();
        $passwordSnap = Setting::where('key' , 'passwordSnap')->pluck('value')->first();
        $idSnap = Setting::where('key' , 'idSnap')->pluck('value')->first();
        $secretSnap = Setting::where('key' , 'secretSnap')->pluck('value')->first();
    ...
    public function paymentUpdate(Request $request){
        ...
        $userSnap = $request->userSnap;
        $passwordSnap = $request->passwordSnap;
        $idSnap = $request->idSnap;
        $secretSnap = $request->secretSnap;
        ...
        $array = [
            ...
            'card' => $card,
            'userSnap' => $userSnap,
            'passwordSnap' => $passwordSnap,
            'idSnap' => $idSnap,
            'secretSnap' => $secretSnap,
