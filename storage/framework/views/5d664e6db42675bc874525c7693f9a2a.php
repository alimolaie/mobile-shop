...
<head>
    ...
    <?php if(\Illuminate\Support\Facades\App::getLocale() == 'fa'): ?>
        <?php if(\App\Models\Setting::where('key' , 'font')->pluck('value')->first() == 0): ?>
            <link rel="stylesheet" href="/css/font-iransans.css" type="text/css" media="print" onload="this.media='all'"/>
        <?php elseif(\App\Models\Setting::where('key' , 'font')->pluck('value')->first() == 1): ?>
            <link rel="stylesheet" href="/css/font-vazir.css" type="text/css" media="print" onload="this.media='all'"/>
        <?php else: ?>
            <link rel="stylesheet" href="/css/font-sahel.css" type="text/css" media="print" onload="this.media='all'"/>
        <?php endif; ?>
    <?php endif; ?>
    <?php if($theme == 1): ?>
        <link rel="stylesheet" href="/css/dark-home.css" type="text/css"/>
    <?php else: ?>

    <?php endif; ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/sass/home.scss']); ?>
    <link rel="styles" media="print" onload="this.media='all'" href="/css/jquery.toast.min.css"/>
    <link rel="stylesheet" media="print" onload="this.media='all'" href="/css/dropify.min.css"/>
    ...
    <body style="display: none">
        ...
        <?php if(\App\Models\Setting::where('key' , 'headerDesign')->pluck('value')->first() == 1): ?>
            <?php echo $__env->make('home.header.headerIndex2' , ['catTop' => $catTop,'catHeader' => $catHeader,'theme' => $theme,'stateContainer' => $stateContainer,'name' => $name,'title' => $title,'logo' => $logo,'heightHeader' => $heightHeader,'imageHeader' => $imageHeader,'adHeaderStatus' => $adHeaderStatus], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php elseif(\App\Models\Setting::where('key' , 'headerDesign')->pluck('value')->first() == 2): ?>
            <?php echo $__env->make('home.header.headerIndex3' , ['catTop' => $catTop,'catHeader' => $catHeader,'theme' => $theme,'stateContainer' => $stateContainer,'name' => $name,'title' => $title,'logo' => $logo,'heightHeader' => $heightHeader,'imageHeader' => $imageHeader,'adHeaderStatus' => $adHeaderStatus], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('home.header.headerIndex' , ['catTop' => $catTop,'catHeader' => $catHeader,'theme' => $theme,'stateContainer' => $stateContainer,'name' => $name,'title' => $title,'logo' => $logo,'heightHeader' => $heightHeader,'imageHeader' => $imageHeader,'adHeaderStatus' => $adHeaderStatus], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php echo $__env->yieldContent('content'); ?>
        <?php if(\App\Models\Setting::where('key' , 'footerDesign')->pluck('value')->first() == 1): ?>
        ...
        <?php elseif(\App\Models\Setting::where('key' , 'footerDesign')->pluck('value')->first() == 2): ?>
            <?php echo $__env->make('home.footer.footerIndex3' , ['catTop' => $catTop,'catHeader' => $catHeader,'theme' => $theme,'stateContainer' => $stateContainer,'name' => $name,'title' => $title,'logo' => $logo,'heightHeader' => $heightHeader,'imageHeader' => $imageHeader,'adHeaderStatus' => $adHeaderStatus], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php else: ?>
        ...
        <?php endif; ?>
        <?php if(\App\Models\Setting::where('key' , 'floatDesign')->pluck('value')->first() == 1): ?>
            <?php echo $__env->make('home.chat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php else: ?>
...
<?php /**PATH D:\Laravel\NewSeo\seoshop\resources\views/home/master.blade.php ENDPATH**/ ?>