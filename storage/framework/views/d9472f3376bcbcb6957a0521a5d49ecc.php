        ...
        <div class="allCreatePost">
            ...
            <div id="infoProduct" class="allCreatePostData">
                <div class="allCreatePostSubject">
                    ...
                    <div class="abilityPost type1">
                        <div class="abilityTitle">
                            <input type="text" name="varName2" placeholder="مثال : سایز">
                            <i id="addSize">
                                <svg class="icon">
                                    <use xlink:href="#add"></use>
                                </svg>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myizonek/public_html/local/resources/views/admin/post/create.blade.php ENDPATH**/ ?>