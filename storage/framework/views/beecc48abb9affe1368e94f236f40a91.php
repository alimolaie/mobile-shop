...
<?php $__env->startSection('content'); ?>
    <main class="allCartIndex width">
        ...
        <?php endif; ?>
        <h1>سبد خرید</h1>
        <h2><?php echo e(\App\Models\Setting::where('key' , 'aboutSeo')->pluck('value')->first()); ?></h2>
                        ...
                        <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="cartItem" id="<?php echo e($item['slug']); ?>">
                                ...
                                <div class="cartSubject">
                                    ...
                                    <?php if($item['user']): ?>
                                        <div class="cartData">
                                            <div class="title3"><?php echo e(__('messages.seller1')); ?> :</div>
                                    ...
                                    <?php if($item['guarantee'] != ''): ?>
                                        <div class="cartData">
                                            <div class="title3"><?php echo e(__('messages.guarantee')); ?> :</div>
                                            <span><?php echo e($item['guarantee']['name']); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($item['options'] && $item['options'] != '[]'): ?>
                                        <?php $__currentLoopData = json_decode($item['options']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="cartData">
                                                <div class="title3">امکان اضافی :</div>
                                                <span><?php echo e($el); ?></span>
                                            </div>
                ...
                <div class="left">
                    <div class="cartNext">
                        <div class="cartPriceItem" id="allPrice1">
                            <div class="title3"><?php echo e(__('messages.price_cart')); ?></div>
                            <span><?php echo e(number_format($prices)); ?> <?php echo e(__('messages.arz')); ?> </span>
                        </div>
                        <div class="cartPriceItem" id="allCountCart">
                            <div class="title3"><?php echo e(__('messages.count_cart')); ?></div>
                            <span><?php echo e($count); ?></span>
                        </div>
                        <div class="cartPriceItem" id="allPrice2">
                            <div class="title3"><?php echo e(__('messages.amount_cart')); ?></div>
                            <div class="price1" id="<?php echo e($prices); ?>"><?php echo e(number_format($prices)); ?> <?php echo e(__('messages.arz')); ?></div>
                        </div>
                        <div class="nextItem">
        ...
        <section class="allCartIndexEmpty" style="display:none">
            ...
            <p><?php echo e(__('messages.empty_cart')); ?></p>
        </section>
    </main>
...
<?php echo $__env->make('home.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myizonek/public_html/local/resources/views/home/cart/cartIndex.blade.php ENDPATH**/ ?>