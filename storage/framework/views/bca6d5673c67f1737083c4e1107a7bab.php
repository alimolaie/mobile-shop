        ...
        <div class="headerTop">
            <div class="block width">
                ...
                <div class="left">
                    <div class="cityChoice">
                        ...
                        <div class="leftCity">
                            <div class="title1"><?php echo e(__('messages.select_loc')); ?></div>
                            <div class="title2"><?php echo e(__('messages.filter_city')); ?></div>
                        </div>
                    </div>
            ...
            <div class="categoryHeaderResponsive">
                ...
                <ul class="allCats">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if(\App\Models\Link::where('parent_id',0)->where('type',0)->where('language', request()->cookie('language') ?? 'fa')->whereHas('children')->count() >= 1): ?>
                        <?php $__currentLoopData = \App\Models\Link::where('parent_id',0)->where('type',0)->where('language', request()->cookie('language') ?? 'fa')->whereHas('children')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lists1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <div class="allCatsTitle">
                                    <a href="<?php echo e($lists1->slug); ?>" name="<?php echo e($lists1->name); ?>" title="<?php echo e($lists1->name); ?>"><?php echo e($lists1->name); ?></a>
                                    <i>
                                        <svg class="icon">
                                            <use xlink:href="#down"></use>
                                        </svg>
                                ...
                                <ul class="allCatsList">
                                    <?php $__currentLoopData = \App\Models\Link::where('parent_id',$lists1->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <div class="allCatsTitle">
                    ...
                    <?php $__currentLoopData = \App\Models\Link::where('parent_id',0)->where('type',0)->where('language', request()->cookie('language') ?? 'fa')->whereHas('children')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lists): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e($lists->slug); ?>" name="<?php echo e($lists->name); ?>" title="<?php echo e($lists->name); ?>">
                                ...
                                <?php if(\App\Models\Link::where('parent_id',$lists->id)->where('language', request()->cookie('language') ?? 'fa')->count() >= 1): ?>
                                    <i>
                                        <svg class="icon">
                                            <use xlink:href="#down"></use>
                                        </svg>
                            ...
                            <div class="divListContainer">
                                <div class="divListsContainer">
                                    <div class="listsContainer">
                                        <?php $__currentLoopData = \App\Models\Link::where('parent_id',$lists->id)->where('language', request()->cookie('language') ?? 'fa')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a class="active" href="<?php echo e($item->slug); ?>" name="<?php echo e($item->name); ?>" title="<?php echo e($item->name); ?>">
                                                <?php echo e($item->name); ?>
                                            ...
                                            <?php $__currentLoopData = \App\Models\Link::where('parent_id',$item->id)->where('language', request()->cookie('language') ?? 'fa')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e($value->slug); ?>" name="<?php echo e($value->name); ?>" title="<?php echo e($value->name); ?>"><?php echo e($value->name); ?></a>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
...
<?php /**PATH D:\Laravel\NewSeo\seoshop\resources\views/home/header/headerIndex.blade.php ENDPATH**/ ?>