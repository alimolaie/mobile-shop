            ...
            <div id="infoProduct" class="allCreatePostData">
                <div class="allCreatePostSubject">
                    ...
                    <div class="abilityPost type1">
                        <div class="abilityTitle">
                            <input type="text" name="varName1" placeholder="مثال : رنگ">
                            <i id="addColor">
                                <svg class="icon">
                                    <use xlink:href="#add"></use>
                                </svg>
                    ...
                    <div class="abilityPost type1">
                        <div class="abilityTitle">
                            <input type="text" name="varName2" placeholder="مثال : ظرفیت">
                            <i id="addSize">
                                <svg class="icon">
                                    <use xlink:href="#add"></use>
                                </svg>
                    ...
                    <div class="abilityPost type1">
                        <div class="abilityTitle">
                            <input type="text" name="varName3" placeholder="مثال : گارنتی">
                            <i id="addSize">
                                <svg class="icon">
                                    <use xlink:href="#add"></use>
                                </svg>
                        ...
                        <table class="abilityTable" id="sizes4">
                            <tr>
                                <th>عنوان</th>
                                <th>تعداد</th>
                                <th>افزودن قیمت (تومان)</th>
                    ...
                    <div class="abilityPost type1">
                        <div class="abilityTitle">
                            <input type="text" name="varName4" placeholder="مثال : ریجستر">
                            <i id="addSize">
                                <svg class="icon">
                                    <use xlink:href="#add"></use>
                                </svg>
                        ...
                        <table class="abilityTable" id="sizes8">
                            <tr>
                                <th>عنوان</th>
                                <th>تعداد</th>
                                <th>افزودن قیمت (تومان)</th>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="allCreatePostDetail">
                        ...
                        <div class="allCreatePostDetailItems">
                            ...
                            <div class="allCreatePostDetailItemState type1">
                                <div class="allCreatePostDetailItem">
            ...
            <div id="seoProduct" class="allCreatePostData" style="display: none">
                <div class="allCreatePostSubject">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" name="skima" placeholder="کد اسکیما را وارد کنید">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" name="rating" placeholder="کد را وارد کنید">
                        <div id="validation-rating"></div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>متاتگ های بیشتر :</label>
                        <textarea name="meta" placeholder="متاتگ را وارد کنید"></textarea>
...
<?php $__env->startSection('scripts3'); ?>
    <script>
        $(document).ready(function(){
            ...
            $(".allCreatePost select[name='type']").val(0);
            ...
            $("button[name='createPost']").click(function(event){
                ...
                $("#sizes4 tr").each(function(){
                    if($(this).find("input").length >= 1) {
                        ...
                        $(this).find("input").each(function () {
                            if (this.name == 'name') {
                                size4.name = this.value;
                            }
                            if (this.name == 'count') {
                                size4.count = this.value;
                            }
                            if (this.name == 'price') {
                                size4.price = this.value >= 1 ?this.value : 0;
                            }
                            if (this.name == 'myImage') {
                                size4.image = this.value;
                            }
                        })
                        sizes4.push(size);
                    }
                ...
                $("#sizes8 tr").each(function(){
                    if($(this).find("input").length >= 1) {
                        ...
                        $(this).find("input").each(function () {
                            if (this.name == 'name') {
                                size8.name = this.value;
                            }
                            if (this.name == 'count') {
                                size8.count = this.value;
                            }
                            if (this.name == 'price') {
                                size8.price = this.value >= 1 ?this.value : 0;
                            }
                            if (this.name == 'myImage') {
                                size8.image = this.value;
                            }
                        })
                        sizes8.push(size);
                    }
            ...
            $('#addColor').click(function (){
                $('#colors').append(
                    $('<tr><td><input type="text" name="name" placeholder="نام را وارد کنید"></td><td><input name="color" type="text" placeholder="کد را وارد کنید"></td><td><input name="count" placeholder="تعداد را وارد کنید"></td><td><input name="price" placeholder="قیمت را وارد کنید"></td><td><div><button class="choiceRelated">انتخاب تصویر</button><input type="hidden" name="myImage"></div></td><td><i id="deleteColor"><svg class="icon"><use xlink:href="#trash"></use></svg></i></td></tr>')
                        .on('click' , '#deleteColor',function(ss){
                            ss.currentTarget.parentElement.parentElement.remove();
                        })
                );
            ...
            $('#addSize').click(function (){
                $('#sizes').append(
                    $('<tr><td><input type="text" name="name" placeholder="عنوان را وارد کنید"></td><td><input type="text" name="count" placeholder="تعداد را وارد کنید"></td><td><input placeholder="قیمت را وارد کنید" name="price"></td><td><div><button class="choiceRelated">انتخاب تصویر</button><input type="hidden" name="myImage"></div></td><td><i id="deleteSize"><svg class="icon"><use xlink:href="#trash"></use></svg></i></td></tr>')
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel projects\shop_mobile\resources\views/admin/post/create.blade.php ENDPATH**/ ?>