            ...
            <div>
                <form method="post" action="/admin/setting/manage" class="settingMangeItems">
                    ...
                    <div class="settingItem">
                        ...
                        <input type="text" name="scoreDay" value="<?php echo e($scoreDay); ?>" placeholder="مثال : 2">
                    </div>
                    <div class="settingItem">
                    ...
                    <div class="settingItem">
                        ...
                        <input type="text" name="backIndex" value="<?php echo e($backIndex); ?>" placeholder="لینک تصویر">
                    </div>
                    <div class="settingItem">
            ...
            <div>
                <form method="post" action="/admin/setting/redirect" class="settingMangeItems">
                    ...
                    <div class="settingItem">
                        ...
                        <input type="text" name="newRedirect" value="<?php echo e($newRedirect); ?>" placeholder="مثال : /newlink">
                    </div>
                    <div class="settingItemChecked">
...
<?php $__env->startSection('scripts3'); ?>
    <script>
        $(document).ready(function(){
            ...
            var deliverStatus = <?php echo json_encode($deliverStatus, JSON_HEX_TAG); ?>;
            var sellerStatus = <?php echo json_encode($sellerStatus, JSON_HEX_TAG); ?>;
            var languageStatus = <?php echo json_encode($languageStatus, JSON_HEX_TAG); ?>;
            var chatStatus = <?php echo json_encode($chatStatus, JSON_HEX_TAG); ?>;
            var ticketStatus = <?php echo json_encode($ticketStatus, JSON_HEX_TAG); ?>;
            var redirectStatus = <?php echo json_encode($redirectStatus, JSON_HEX_TAG); ?>;
            var preLoaderStatus = <?php echo json_encode($preLoaderStatus, JSON_HEX_TAG); ?>;
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myizonek/public_html/local/resources/views/admin/setting/manage.blade.php ENDPATH**/ ?>