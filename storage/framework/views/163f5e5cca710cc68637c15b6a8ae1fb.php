    ...
    <div class="headerFix">
        <div class="headerTop">
            <div class="block width">
                <div class="right">
                    <a href="tel:<?php echo e(\App\Models\Setting::where('key' , 'number')->pluck('value')->first()); ?>" rel="nofollow" class="option">
                        <i>
                            <svg class="icon">
                    ...
                    <a href="mailto:<?php echo e(\App\Models\Setting::where('key' , 'email')->pluck('value')->first()); ?>" rel="nofollow" class="option">
                        <i>
                            <svg class="icon">
                ...
                <div class="left">
                    <ul>
                        <li>
                            <a href="<?php echo e($telegram); ?>" rel="nofollow">
                                <i>
                                    <svg class="icon">
                        ...
                        <li>
                            <a href="<?php echo e($facebook); ?>" rel="nofollow">
                                <i>
                                    <svg class="icon">
                        ...
                        <li>
                            <a href="<?php echo e($instagram); ?>" rel="nofollow">
                                <i>
                                    <svg class="icon">
                        ...
                        <li>
                            <a href="<?php echo e($twitter); ?>" rel="nofollow">
                                <i>
                                    <svg class="icon">
                        ...
                        <div class="flagHeader">
                            ...
                            <div class="flagList" style="display: none">
                                <div class="item" id="fa">
                                    <img src="/img/fa.png" width="200" height="200" alt="iran">
                                </div>
                                <div class="item" id="en">
                                    <img src="/img/en.png" width="200" height="200" alt="english">
                                </div>
                                <div class="item" id="ar">
                                    <img src="/img/ar.png" width="200" height="200" alt="arabia">
                                </div>
                                <div class="item" id="tr">
                                    <img src="/img/tr.png" width="200" height="200" alt="turkey">
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
            ...
            <div class="categoryHeaderResponsive">
                ...
                <ul class="allCats">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = \App\Models\Link::where('parent_id',0)->where('type',0)->where('language', request()->cookie('language') ?? 'fa')->whereHas('children')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lists): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <div class="allCatsTitle">
                                <a href="<?php echo e($lists->slug); ?>" name="<?php echo e($lists->name); ?>" title="<?php echo e($lists->name); ?>"><?php echo e($lists->name); ?></a>
                                <i>
                                    <svg class="icon">
                                        <use xlink:href="#down"></use>
                                    </svg>
                            ...
                            <ul class="allCatsList">
                                <?php $__currentLoopData = \App\Models\Link::where('parent_id',$lists->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <div class="allCatsTitle">
                                            <a href="<?php echo e($list->slug); ?>" name="<?php echo e($list->name); ?>" title="<?php echo e($list->name); ?>"><?php echo e($list->name); ?></a>
                                        </div>
                                        <ul>
                                            <?php $__currentLoopData = \App\Models\Link::where('parent_id',$list->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li>
                                                    <div class="allCatsTitle">
                                                        <a href="<?php echo e($item->slug); ?>" name="<?php echo e($item->name); ?>" title="<?php echo e($item->name); ?>"><?php echo e($item->name); ?></a>
                                                    </div>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = \App\Models\Link::where('parent_id',0)->where('type',0)->where('language', request()->cookie('language') ?? 'fa')->doesntHave('children')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lists): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <div class="allCatsTitle">
            ...
            <nav class="width">
                <div class="logo">
                    <a href="/" title="<?php echo e($title); ?>" name="<?php echo e($name); ?>" class="pic">
                        <img class="lazyload" width="200" height="200" src="/img/404Image.png" data-src="<?php echo e($logo); ?>" alt="<?php echo e($title); ?>">
                    </a>
                </div>
                <ul class="headerList">
                    <li class="allHeaderHomeBlockBotCategory">
                        ...
                        <div class="allHeaderHomeBlockBotCategoryItems width">
                            ...
                            <?php $__currentLoopData = \App\Models\Link::where('parent_id',0)->where('type',0)->where('language', request()->cookie('language') ?? 'fa')->whereHas('children')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lists): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="allHeaderHomeBlockBotCategoryItem">
                                    <a href="<?php echo e($lists->slug); ?>" name="<?php echo e($lists->name); ?>" title="<?php echo e($lists->name); ?>" class="allHeaderHomeBlockBotCategoryItemTitle">
                                        <?php echo e($lists->name); ?>
                                    ...
                                    <div class="allHeaderHomeBlockBotCategoryItemLists">
                                        <?php $__currentLoopData = \App\Models\Link::where('parent_id',$lists->id)->where('language', request()->cookie('language') ?? 'fa')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="allHeaderHomeBlockBotCategoryItemList">
                                                <a href="<?php echo e($list->slug); ?>" name="<?php echo e($list->name); ?>" title="<?php echo e($list->name); ?>" class="active">
                                                    <?php echo e($list->name); ?>
                                                ...
                                                <?php $__currentLoopData = \App\Models\Link::where('parent_id',$list->id)->where('language', request()->cookie('language') ?? 'fa')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <a href="<?php echo e($val->slug); ?>" name="<?php echo e($val->name); ?>" title="<?php echo e($val->name); ?>"><?php echo e($val->name); ?></a>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                ...
                                <div class="showCartContainer">
                                    <div class="liCart">
                                        ...
                                        <div class="showCartEmpty">
                                            ...
                                            <div class="title1"><?php echo e(__('messages.empty_cart')); ?></div>
                                        </div>
                                    </div>
                    ...
                    <?php if(auth()->user()): ?>
                        <div class="user">
                            ...
                            <ul id="showUser2">
                                <li>
                                    <div class="picUser">
                                        <img width="200" height="200" src="/img/user.png" alt="user">
                                    </div>
                                    <div class="infoUser">
                                ...
                                <li>
                                    <a href="/profile/bookmark" rel="nofollow">
                                        <?php echo e(__('messages.bookmark_user')); ?>

                                    </a>
                                </li>
                                <li>
                                    <a href="/profile/like" rel="nofollow">
                                        <?php echo e(__('messages.like_user')); ?>

                                    </a>
                                </li>
                                <li>
                                    <a href="/profile/pay" rel="nofollow">
...
<?php /**PATH /home/myizonek/public_html/local/resources/views/home/header/headerIndex2.blade.php ENDPATH**/ ?>