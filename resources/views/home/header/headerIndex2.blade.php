    ...
    <div class="headerFix">
        <div class="headerTop">
            <div class="block width">
                <div class="right">
                    <a href="tel:{{\App\Models\Setting::where('key' , 'number')->pluck('value')->first()}}" rel="nofollow" class="option">
                        <i>
                            <svg class="icon">
                    ...
                    <a href="mailto:{{\App\Models\Setting::where('key' , 'email')->pluck('value')->first()}}" rel="nofollow" class="option">
                        <i>
                            <svg class="icon">
            ...
            <div class="categoryHeaderResponsive">
                ...
                <ul class="allCats">
                    ...
                    @foreach(\App\Models\Link::where('parent_id',0)->where('type',0)->where('language', request()->cookie('language') ?? 'fa')->whereHas('children')->get() as $lists)
                        <li>
                            <div class="allCatsTitle">
                                <a href="{{$lists->slug}}" name="{{$lists->name}}" title="{{$lists->name}}">{{$lists->name}}</a>
                                <i>
                                    <svg class="icon">
                                        <use xlink:href="#down"></use>
                                    </svg>
            ...
            <nav class="width">
                <div class="logo">
                    <a href="/" title="{{$title}}" name="{{$name}}" class="pic">
                        <img class="lazyload" width="200" height="200" src="/img/404Image.png" data-src="{{$logo}}" alt="{{$title}}">
                    </a>
                </div>
                <ul class="headerList">
                    <li class="allHeaderHomeBlockBotCategory">
                        ...
                        <div class="allHeaderHomeBlockBotCategoryItems width">
                            ...
                            @foreach(\App\Models\Link::where('parent_id',0)->where('type',0)->where('language', request()->cookie('language') ?? 'fa')->whereHas('children')->get() as $lists)
                                <div class="allHeaderHomeBlockBotCategoryItem">
                                    <a href="{{$lists->slug}}" name="{{$lists->name}}" title="{{$lists->name}}" class="allHeaderHomeBlockBotCategoryItemTitle">
                                        {{$lists->name}}
                                        <i>
                                            <svg class="icon">
                                                <use xlink:href="#left"></use>
                                    ...
                                    <div class="allHeaderHomeBlockBotCategoryItemLists">
                                        @foreach(\App\Models\Link::where('parent_id',$lists->id)->where('language', request()->cookie('language') ?? 'fa')->get() as $list)
                                            <div class="allHeaderHomeBlockBotCategoryItemList">
                                                ...
                                                @foreach(\App\Models\Link::where('parent_id',$list->id)->where('language', request()->cookie('language') ?? 'fa')->get() as $val)
