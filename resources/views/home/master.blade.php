...
<head>
    ...
    <body style="display: none">
        ...
        @yield('map')
        @include('icons')
        @if(\App\Models\Setting::where('key' , 'headerDesign')->pluck('value')->first() == 1)
            @include('home.header.headerIndex2' , ['catTop' => $catTop,'catHeader' => $catHeader,'theme' => $theme,'stateContainer' => $stateContainer,'name' => $name,'title' => $title,'logo' => $logo,'heightHeader' => $heightHeader,'imageHeader' => $imageHeader,'adHeaderStatus' => $adHeaderStatus])
        @elseif(\App\Models\Setting::where('key' , 'headerDesign')->pluck('value')->first() == 2)
            @include('home.header.headerIndex3' , ['catTop' => $catTop,'catHeader' => $catHeader,'theme' => $theme,'stateContainer' => $stateContainer,'name' => $name,'title' => $title,'logo' => $logo,'heightHeader' => $heightHeader,'imageHeader' => $imageHeader,'adHeaderStatus' => $adHeaderStatus])
        @else
            @include('home.header.headerIndex' , ['catTop' => $catTop,'catHeader' => $catHeader,'theme' => $theme,'stateContainer' => $stateContainer,'name' => $name,'title' => $title,'logo' => $logo,'heightHeader' => $heightHeader,'imageHeader' => $imageHeader,'adHeaderStatus' => $adHeaderStatus])
        @endif
        @yield('content')
        @if(\App\Models\Setting::where('key' , 'footerDesign')->pluck('value')->first() == 1)
        ...
        @elseif(\App\Models\Setting::where('key' , 'footerDesign')->pluck('value')->first() == 2)
            @include('home.footer.footerIndex3' , ['catTop' => $catTop,'catHeader' => $catHeader,'theme' => $theme,'stateContainer' => $stateContainer,'name' => $name,'title' => $title,'logo' => $logo,'heightHeader' => $heightHeader,'imageHeader' => $imageHeader,'adHeaderStatus' => $adHeaderStatus])
        @else
        ...
        @endif
        @if(\App\Models\Setting::where('key' , 'floatDesign')->pluck('value')->first() == 1)
            @include('home.chat')
        @else
