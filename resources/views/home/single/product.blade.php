    ...
    <main class="allSingleIndex">
            ...
            <div class="imageContainer">
                @if($post->suggest)
                    <div class="suggestProduct">
                        <div class="title2">{{__('messages.suggest_product')}}</div>
            ...
            <div class="singleData">
                ...
                <div class="singleInfo">
                    <div class="right">
                        ...
                        @if($post->ability)
                            <div class="ability">
                                <div class="title1">{{__('messages.product_property')}}</div>
                                <ul>
                        ...
                        <div class="boxes">
                            ...
                            <div class="box">
                                <div class="title1">{{__('messages.brand')}} :</div>
                                <ul>
                        ...
                        @if($post->lotteryStatus == 1)
                            <div class="lottery">
                                <div class="titleLottery">
                                    <div class="title1">{{$allLottery - $lastLottery}} {{__('messages.lottery_exits')}} </div>
                                </div>
                        ...
                        @if($post->user)
                            <a href="/mall/{{$post->user->slug}}" class="detailRightOptions">
                                ...
                                <div class="description">
                                    <div class="title1">{{$post->user->name}}</div>
                                </div>
                            </a>
                        @endif
                        <div class="leftData">
                            @if($levelUser)
                                @if($post->levels)
                                    @if($post['levels'] != '[]')
                                        @foreach(json_decode($post['levels']) as $item)
                                            @if(in_array($item->name, $levelUser))
                                                <div class="leftDataItem">
                                                    <div class="title1">{{__('messages.price_me')}} :</div>
                                                    <div class="prices">
                                                        <div class="priceData">
                                        ...
                                        @endforeach
                                        <div class="leftDataItem">
                                            <div class="title1">{{__('messages.product_price')}} :</div>
                                            <div class="prices">
                                                @if($post->off)
                                                    <div class="off">
                            ...
                            @endif
                            <div class="leftDataItem">
                                <div class="title1">{{__('messages.count_status')}} :</div>
                                @if($post->count >= 1)
                            ...
                            @if($post->count >= 1)
                                <div class="leftDataItem">
                                    <div class="title1">{{__('messages.deliver_time')}} :</div>
                            ...
                            @else
                                @if($post->prebuy)
                                    <div class="leftDataItem">
                                        <div class="title1">{{__('messages.prepare_time')}} :</div>
                                        <span>{{$post->prepare}}</span>
                                    </div>
                                @endif
                            @endif
                            <div class="leftDataItem">
                                <div class="title1">{{__('messages.product_code')}} :</div>
                    ...
                    <div class="leftCollect">
                        ...
                        <ul>
                            ...
                            @if(count($item->product) >= 3)
                                <li>
                                    <div class="title3">{{__('messages.and')}}</div>
                                </li>
                            @endif
                        </ul>
        ...
        @if(count($post->lottery) >= 1)
            <div class="allLotterySingle width">
                <div class="title">
                    ...
                    <div class="title1">{{__('messages.lottery')}}</div>
                </div>
                <div class="items">
        ...
        @if(count($related) >= 1)
            <section class="allProductList width">
                <div class="title">
                    <div class="title1">{{__('messages.product_rel')}}</div>
                </div>
