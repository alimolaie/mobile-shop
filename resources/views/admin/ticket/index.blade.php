                ...
                if(ticket >= 1){
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            var gs = (data.pay ? `<a target="_blank" href="/admin/pay/${data.pay.id}">( جزییات سفارش )</a>` : null);
                            if(data.pay){
                                $(".chat .move1").attr('href' , '/admin/pay/'+data.pay.id);
                            }
                            data.pay ? $(".chat .move1").show() : $(".chat .move1").hide();
                            $(".chat .chat-with").text('گفتگو با ' + data.user.name)
