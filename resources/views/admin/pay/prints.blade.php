            ...
            <div class="page">
                <div class="top">
                    <div class="right">
                        ...
                        @foreach ($payMetas->slice(0, 10) as $payMeta)
                        <div class="item">
                            <h4>نام محصول:</h4>
                            <div class="text">
                                <h5>{{$payMeta->product()->pluck('title')->first()}}</h5>
                            </div>
                        </div>
                        <div class="item">
                            <h4>ظرفیت محصول:</h4>
                            <div class="text">
                                ...
                                <h5>{{ json_decode($payMeta->product->size[0]) }}</h5>
                        ...
                        <div class="item">
                            <h4>رنگ محصول:</h4>
                            <div class="text">
                                <h5>{{ json_decode($payMeta->product->colors[0]) }}</h5>
                            </div>
                        </div>
                        @endforeach
