        ...
        <div class="abilityPost change20">
            <div id="chair" class="chairs container">
                ...
                <div class="hallPosition">
                    @foreach(\App\Models\Story::where('parent_id' , 0)->get() as $item)
                        <div class="positionItem">
                            <div class="titlePosition">
                                <input type="text" name="titleStory" value="{{$item->title}}" placeholder="عنوان">
                                <input type="text" name="coverStory" value="{{$item->cover}}" placeholder="تصویر کاور">
                                <i class="addStory1">
                                    <svg class="icon">
                                        <use xlink:href="#add"></use>
                                    </svg>
                            ...
                            @foreach(\App\Models\Story::where('parent_id' , $item->id)->get() as $val)
                                <div class="chairsData">
                                    <input type="text" name="urlStory1" value="{{$val->image}}" placeholder="لینک جهت باز شدن">
                                    <select name="typeStory1">
                                        <option {{$val->type != 1 ? 'selected' : ''}} value="0">عکس</option>
                                        <option {{$val->type == 1 ? 'selected' : ''}} value="1">فیلم</option>
                                    </select>
                                    <input type="text" value="{{$val->cover}}" name="imageStory1" placeholder="لینک ویدئو / تصویر">
                                    <input type="text" name="dayStory1" value="{{$val->day}}" placeholder="زمان هر استوری (ثانیه)">
                                    <i class="deleteStory">
                                        <svg class="icon">
                                            <use xlink:href="#trash"></use>
                                        </svg>
