            ...
            <div>
                <form action="/admin/collection" class="createFilled" method="post">
                    ...
                    <div class="abilityPost">
                        ...
                        <table class="abilityTable" id="options">
                            <tr>
                                <th>عنوان</th>
                                <th>توضیح</th>
                                <th>قیمت</th>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#addOption').click(function (){
                $('#options').append(
                    $('<tr class="newTr1"><td><input type="text" name="titleO[]" value="" placeholder="عنوان را وارد کنید"></td><td><input type="text" name="bodyO[]" value="" placeholder="توضیح را وارد کنید"></td><td><input type="text" name="priceO[]" value="" placeholder="قیمت را وارد کنید"></td><td><i id="deleteRate"><svg class="icon"><use xlink:href="#trash"></use></svg></i></td></tr>')
            ...
            $('.allTables .buttons').on('click' , '.editButton' ,function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(JSON.parse(data.options),function (){
                            $('#options').append(
                                $('<tr class="newTr1"><td><input type="text" name="titleO[]" value="'+this.title+'" placeholder="عنوان را وارد کنید"></td><td><input type="text" name="bodyO[]" value="'+this.body+'" placeholder="توضیح را وارد کنید"></td><td><input type="text" name="priceO[]" value="'+this.price+'" placeholder="قیمت را وارد کنید"></td><td><i id="deleteRate"><svg class="icon"><use xlink:href="#trash"></use></svg></i></td></tr>')
                                    .on('click' , '#deleteRate',function(ss){
                                        ss.currentTarget.parentElement.parentElement.remove();
                                    })
                            );
