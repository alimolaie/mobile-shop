<div class="showAllShare">
    <div class="showAllShareHome">
        <div class="showAllShareTop">
            <div class="title2"><?php echo e(__('messages.social2')); ?></div>
        </div>
        <div class="showAllShareItems">
            <div class="showAllShareItem">
                <div class="showAllShareItemName">
                    <div class="title2"><?php echo e(__('messages.twitter1')); ?></div>
            ...
            <div class="showAllShareItem">
                <div class="showAllShareItemName">
                    <div class="title2"><?php echo e(__('messages.telegram1')); ?></div>
            ...
            <div class="showAllShareItem">
                <div class="showAllShareItemName">
                    <div class="title2"><?php echo e(__('messages.face1')); ?></div>
            ...
            <div class="showAllShareItem">
                <div class="showAllShareItemName">
                    <div class="title2"><?php echo e(__('messages.whatsapp1')); ?></div>
        ...
        <div class="showAllShareTag">
            ...
            <div class="title2"><?php echo e(url('')); ?>/productID/<?php echo e($slug); ?></div>
        </div>
    </div>
</div>
<?php /**PATH G:\Laravel\NewSeo\seoshop\resources\views/home/single/share.blade.php ENDPATH**/ ?>