                ...
                <ul id="showList3" class="active">
                    <li>
                        <a href="/admin/redirect">
                            ...
                            <span class="sidemenu-label">
                                ریدایرکت
                                <span class="countData"><?php echo e(\App\Models\Redirect::count()); ?></span>
                            </span>
                        </a>
                    </li>
                    <li>
                ...
                <ul id="showList18" class="active">
                    <li>
                        <a href="/admin/chat">
                            ...
                            <span class="sidemenu-label">
                                گفتگو آنلاین
                                <span class="countData"><?php echo e(\App\Models\Ticket::where('status' , 1)->count()); ?></span>
                            </span>
                        </a>
                    </li>
                    <li>
                        <a href="/admin/ticket">
                            ...
                            <span class="sidemenu-label">
                                پیام پشتیبانی
                                <span class="countData"><?php echo e(\App\Models\Ticket::where('status' , 0)->count()); ?></span>
                            </span>
                        </a>
                    </li>
                    <li>
...
<?php /**PATH /home/izoneka1/new.izonekala.com/local/resources/views/admin/side/sidebar.blade.php ENDPATH**/ ?>