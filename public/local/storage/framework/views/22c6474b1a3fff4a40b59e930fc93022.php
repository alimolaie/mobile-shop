    ...
    <main class="allSingleIndex">
            ...
            <div class="imageContainer">
                <?php if($post->suggest): ?>
                    <div class="suggestProduct">
                        <div class="title2"><?php echo e(__('messages.suggest_product')); ?></div>
            ...
            <div class="singleData">
                ...
                <div class="singleInfo">
                    <div class="right">
                        ...
                        <?php if($post->ability): ?>
                            <div class="ability">
                                <div class="title1"><?php echo e(__('messages.product_property')); ?></div>
                                <ul>
                        ...
                        <div class="boxes">
                            <div class="box">
                                <div class="title1"><?php echo e(__('messages.cats')); ?> :</div>
                                <ul>
                                    <?php $__currentLoopData = $post['category']->slice(0,1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a href="/category/<?php echo e($address->slug); ?>"><?php echo e($address->name); ?></a>
                            ...
                            <div class="box">
                                <div class="title1"><?php echo e(__('messages.brand')); ?> :</div>
                                <ul>
                        ...
                        <?php if($post->lotteryStatus == 1): ?>
                            <div class="lottery">
                                <div class="titleLottery">
                                    <div class="title1"><?php echo e($allLottery - $lastLottery); ?> <?php echo e(__('messages.lottery_exits')); ?> </div>
                                </div>
                    ...
                    <div class="left">
                        <?php if($post->user): ?>
                            <a href="/mall/<?php echo e($post->user->slug); ?>" class="detailRightOptions">
                                ...
                                <div class="description">
                                    <div class="title1"><?php echo e($post->user->name); ?></div>
                                </div>
                            </a>
                        <?php endif; ?>
                        <div class="leftData">
                            <?php if($levelUser): ?>
                                <?php if($post->levels): ?>
                                    <?php if($post['levels'] != '[]'): ?>
                                        <?php $__currentLoopData = json_decode($post['levels']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(in_array($item->name, $levelUser)): ?>
                                                <div class="leftDataItem">
                                                    <div class="title1"><?php echo e(__('messages.price_me')); ?> :</div>
                                                    <div class="prices">
                                                        <div class="priceData">
                                                            <div class="price1"><?php echo e(number_format($item->price)); ?></div>
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <div class="leftDataItem">
                                            <div class="title1"><?php echo e(__('messages.product_price')); ?> :</div>
                                            <div class="prices">
                                                <?php if($post->off): ?>
                                                    <div class="off">
                            ...
                            <?php endif; ?>
                            <div class="leftDataItem">
                                <div class="title1"><?php echo e(__('messages.count_status')); ?> :</div>
                                <?php if($post->count >= 1): ?>
                            ...
                            <?php if($post->count >= 1): ?>
                                <div class="leftDataItem">
                                    <div class="title1"><?php echo e(__('messages.deliver_time')); ?> :</div>
                            ...
                            <?php else: ?>
                                <?php if($post->prebuy): ?>
                                    <div class="leftDataItem">
                                        <div class="title1"><?php echo e(__('messages.prepare_time')); ?> :</div>
                                        <span><?php echo e($post->prepare); ?></span>
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                            <div class="leftDataItem">
                                <div class="title1"><?php echo e(__('messages.product_code')); ?> :</div>
                        ...
                        <?php if($post->note): ?>
                            <div class="note">
                                <div class="noteTitle">
                                    <div class="title2"><?php echo e(__('messages.news')); ?></div>
                                    <div class="title2"><?php echo e(__('messages.news')); ?></div>
                                </div>
                ...
                <div class="collectionProduct width">
                    <div class="rightCollect">
                        <a href="/product/<?php echo e($post->slug); ?>" class="collectProduct">
                            ...
                            <div class="title2"><?php echo e($post->product_id); ?></div>
                            <div class="title1"><?php echo e($post->title); ?></div>
                        </a>
                        <?php $__currentLoopData = $item->product->slice(0,1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="/product/<?php echo e($value->slug); ?>" class="collectProduct">
                                ...
                                <div class="title2"><?php echo e($value->product_id); ?></div>
                                <div class="title1"><?php echo e($value->title); ?></div>
                            </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="leftCollect">
                        ...
                        <ul>
                            ...
                            <?php if(count($item->product) >= 3): ?>
                                <li>
                                    <div class="title3"><?php echo e(__('messages.and')); ?></div>
                                </li>
                            <?php endif; ?>
                        </ul>
        ...
        <?php if(count($post->lottery) >= 1): ?>
            <div class="allLotterySingle width">
                <div class="title">
                    ...
                    <div class="title1"><?php echo e(__('messages.lottery')); ?></div>
                </div>
                <div class="items">
        ...
        <?php if(count($post->tag) >= 1): ?>
            <div class="tags width">
                <div class="title1"><?php echo e(__('messages.tags')); ?> :</div>
                <ul>
        ...
        <?php if(count($related) >= 1): ?>
            <section class="allProductList width">
                <div class="title">
                    <div class="title1"><?php echo e(__('messages.product_rel')); ?></div>
                </div>
        ...
        <section class="detailProducts width">
            ...
            <div>
                <div class="detailBox">
                    ...
                    <div class="title2"><?php echo e($post->title); ?></div>
                    <div class="price1" id="finalP"><?php echo e($post->price); ?></div>
                    <div class="addButton" id="addCart">
                        <i>
                            <svg class="icon">
                                <use xlink:href="#cart"></use>
...
<?php $__env->startSection('torobTag'); ?>
    ...
    <meta name="description" content="<?php echo e($post->short); ?>">
    <?php if($post->user): ?>
...
<?php echo $__env->make('home.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\NewSeo\seoshop\resources\views/home/single/product.blade.php ENDPATH**/ ?>