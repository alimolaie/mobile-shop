            ...
            <div class="items">
                ...
                <div class="allPayChartTopsItem">
                    ...
                    <a href="/product/<?php echo e($item->slug); ?>" class="pic">
                        <img alt="<?php echo e($item->title); ?>" src="<?php echo e($item->image != '[]'?json_decode($item->image)[0]:''); ?>">
                    </a>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/izoneka1/new.izonekala.com/local/resources/views/admin/chart/index.blade.php ENDPATH**/ ?>