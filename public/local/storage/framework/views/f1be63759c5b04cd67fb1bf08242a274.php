                        ...
                        <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="cartItem" id="<?php echo e($item['slug']); ?>">
                                ...
                                <div class="cartSubject">
                                    ...
                                    <?php if($item['size']): ?>
                                        <div class="cartData">
                                            <div class="title3"><?php echo e(__('messages.size')); ?> :</div>
                                            <span><?php echo e($item['size']); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($item['color']): ?>
                                        <div class="cartData">
                                            <div class="title3"><?php echo e(__('messages.color')); ?> :</div>
...
<?php echo $__env->make('home.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\Laravel\NewSeo\seoshop\resources\views/home/cart/cartIndex.blade.php ENDPATH**/ ?>