    ...
    <div class="allProduct">
        <div class="topProductIndex">
            ...
            <div class="allTopTableItem">
                ...
                <div class="groupEdits">ویرایش گروهی</div>
                ...
                <div id="<?php echo e($item->id); ?>" class="postItem newTr">
                    <div class="postTop">
                        ...
                        <div class="postOptions grid3">
                            <a href="/admin/product/<?php echo e($item->id); ?>/show" target="_blank" title="آمارگیری محصول">آمارگیری</a>
                            <a href="/product/<?php echo e($item->slug); ?>" target="_blank" title="پیشنمایش محصول">پیشنمایش</a>
                            <a href="/admin/product/<?php echo e($item->id); ?>/seo" target="_blank" title="بررسی سئو محصول">بررسی سئو</a>
                            <a href="/admin/product/<?php echo e($item->id); ?>/edit" target="_blank" title="ویرایش محصول">ویرایش</a>
                            <a href="/admin/product/<?php echo e($item->id); ?>/copy" target="_blank" title="کپی محصول">کپی</a>
                    ...
                    <div class="postBot">
                        <ul>
                            <li>
                                <span>نوع :</span>
                                <?php if($item->type): ?>
                                    <span class="unActive">دانلودی</span>
                                <?php else: ?>
                                    <span class="active">فیزیکی</span>
                                <?php endif; ?>
                            </li>
                            <li>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/izoneka1/new.izonekala.com/local/resources/views/admin/post/index.blade.php ENDPATH**/ ?>