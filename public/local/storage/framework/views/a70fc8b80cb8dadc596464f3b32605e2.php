...
<?php $__env->startSection('content'); ?>
    <div class="allManageSetting">
        ...
        <form method="post" action="/admin/setting/message" class="settingMangeItems">
            ...
            <div class="settingItem">
                <label for="">کد پترن ارسال تیکت به کاربر(دو متغیر : متغیر اول نام کاربر و متغیر دوم شناسه تیکت)</label>
                <input type="text" name="messageTicket" value="<?php echo e($messageTicket); ?>" placeholder="مثال : 2222">
            </div>
            <div class="settingItem">
                <label for="">کد پترن ارسال تیکت به مدیریت(دو متغیر : متغیر اول نام کاربر و متغیر دوم شناسه تیکت)</label>
                <input type="text" name="messageTicketManager" value="<?php echo e($messageTicketManager); ?>" placeholder="مثال : 2222">
            </div>
            <div class="settingItem">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myizonek/public_html/local/resources/views/admin/setting/message.blade.php ENDPATH**/ ?>