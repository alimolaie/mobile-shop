<div class="allStoryContainer width">
    <div class="allStoryIndex">
        <div class="titleStory"><?php echo e($data['title']); ?></div>
        <div class="storyItems">
            <?php $__currentLoopData = $data['post']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="storyItem" id="story<?php echo e($item->id); ?>">
                    <?php if(in_array($item->id, $storySeen)): ?>
                        <div class="storyPic unActive">
                            <img src="<?php echo e($item->cover); ?>" alt="<?php echo e($item->id); ?>">
                        </div>
                    <?php else: ?>
                        <div class="storyPic">
                            <img src="<?php echo e($item->cover); ?>" alt="<?php echo e($item->id); ?>">
                    ...
                    <?php endif; ?>
                    <div class="storyName"><?php echo e($item->title); ?></div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <?php $__currentLoopData = $data['post']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="storyFloatHide" data-num="story<?php echo e($parent->id); ?>">
                        ...
                        <div class="daily-stories">
                            <div class="daily-stories__outer">
                                <div class="daily-stories__container">
                                    <?php $__currentLoopData = $parent['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="slide" data-link="<?php echo e($item->image); ?>" data-timeout="<?php echo e($item->day); ?>000">
                                            <?php if($item->type == 0): ?>
                                                <img src="<?php echo e($item->cover); ?>" alt="<?php echo e($item->title); ?>" title="<?php echo e($item->title); ?>" />
                                            <?php else: ?>
                                                <video src="<?php echo e($item->cover); ?>" loop autoplay preload="true"></video>
                                            <?php endif; ?>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            ...
                            <div class="progress-bars" data-count="4">
                                <?php $__currentLoopData = $parent['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bar <?php echo e($item->type ? 'video' : ''); ?>" data-index="<?php echo e($loop->index); ?>"><span style="animation-duration: <?php echo e($item->day); ?>000ms;"></span></div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php $__env->startSection('script4'); ?>
    <script>
...
<?php /**PATH /home/myizonek/public_html/local/resources/views/home/index/storyIndex.blade.php ENDPATH**/ ?>