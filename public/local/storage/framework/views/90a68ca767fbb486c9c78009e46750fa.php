    ...
    <div class="allCreatePost">
        <div class="allCreatePost">
            ...
            <div class="showData">
                ...
                <button data-for="tankProduct" class="type1">اطلاعات انبارداری</button>
                <button data-for="seoProduct">اطلاعات سئو*</button>
            </div>
            <div id="infoProduct" class="allCreatePostData">
                <div class="allCreatePostSubject">
                    ...
                    <div class="abilityPost type1">
                        <div class="abilityTitle">
                            <input type="text" name="varName1" value="<?php echo e($posts->varName1); ?>" placeholder="مثال : رنگ">
                            <i id="addColor">
                                <svg class="icon">
                                    <use xlink:href="#add"></use>
                                </svg>
                    ...
                    <div class="abilityPost type1">
                        <div class="abilityTitle">
                            <input type="text" name="varName2" value="<?php echo e($posts->varName2); ?>" placeholder="مثال : رنگ">
                            <i id="addSize">
                                <svg class="icon">
                                    <use xlink:href="#add"></use>
                                </svg>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="allCreatePostDetail">
                        ...
                        <div class="allCreatePostDetailItems">
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <select name="type">
                                    <option value="0" selected>محصول فیزیکی</option>
                                    <option value="1">محصول دانلودی</option>
                                </select>
                                <div id="validation-language"></div>
                            </div>
                            <div class="allCreatePostDetailItem">
                    ...
                    <div class="allCreatePostDetail">
                        ...
                        <div class="allCreatePostDetailItems">
                            ...
                            <div class="allCreatePostDetailItem">
                                ...
                                <label for="s6d" class="allCreatePostDetailItemData type1">
                                    امکان پیش خرید
            ...
            <div id="tankProduct" class="allCreatePostData type1" style="display: none">
                <div class="allTanks">
                    <div class="allCreatePostItem">
            ...
            <div id="seoProduct" class="allCreatePostData" style="display: none">
                <div class="allCreatePostSubject">
                    <div class="allCreatePostItem">
                        <label>عنوان سئو* :</label>
                        <input type="text" name="titleSeo" value="<?php echo e($posts->titleSeo); ?>" placeholder="عنوان را وارد کنید">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <div class="detailPrices">
                            <input type="text" name="keywordSeo" value="<?php echo e($posts->keywordSeo); ?>" placeholder="با , جدا کنید">
                            <button class="autoKeyword">دریافت خودکار</button>
                        </div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>alt تصویر* :</label>
                        <input type="text" name="imageAlt" value="<?php echo e($posts->imageAlt); ?>" placeholder="عنوان را وارد کنید">
                        <div id="validation-imageAlt"></div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>کد اسکیما :</label>
                        <input type="text" name="skima" value="<?php echo e($posts->skima); ?>" placeholder="کد اسکیما را وارد کنید">
                        <div id="validation-skima"></div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>متاتگ ربات :</label>
                        <select name="robots">
                            ...
                            <option value="unavailable_after">unavailable_after</option>
                            <option value="noarchive">noarchive</option>
                            <option value="nocache">nocache</option>
                            <option value="notranslate">notranslate</option>
                            <option value="nositelinkssearchbox">nositelinkssearchbox</option>
                            <option value="nopagereadaloud">nopagereadaloud</option>
                            <option value="max-snippet">max-snippet</option>
                            <option value="max-video-preview">max-video-preview</option>
                            <option value="rating">rating</option>
                            <option value="noydir">noydir</option>
                            <option value="noodp">noodp</option>
                        </select>
                        <div id="validation-robots"></div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>کد ریتینگ :</label>
                        <input type="text" value="<?php echo e($posts->rating); ?>" name="rating" placeholder="کد را وارد کنید">
                        <div id="validation-rating"></div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>متاتگ های بیشتر :</label>
                        <textarea name="meta" placeholder="متاتگ را وارد کنید"><?php echo e($posts->meta); ?></textarea>
                        <div id="validation-meta"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="choicePic" style="display:none;">
            <div class="allPic">
                <div class="data"></div>
                <div class="choice1">
                    <button class="submitPic">ثبت</button>
                    <button class="cancelPic">انصراف</button>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startSection('scripts3'); ?>
    <script>
        $(document).ready(function(){
            ...
            $("select[name='robots']").val(posts.robots);
            $(".allCreatePost select[name='state']").val('');
            $(".allCreatePost select[name='city']").val('');
            $(".allCreatePost select[name='type']").val(posts.type);
            changeT(posts.type);
            $(".allCreatePost select[name='type']").on('change' , function(e){
                changeT($(this).val());
            })
            function changeT(val1){
                if(val1 == 0){
                    $(".type1").show();
                    $(".type2").hide();
                    $(".tv1").text('ویدئو محصول');
                }else{
                    $(".type1").hide();
                    $(".type2").show();
                    $(".tv1").text('فایل دانلودی');
                }
            }
            ...
            $('.autoKeyword').click(function (){
                ...
                $.ajax({
                    url: "/admin/product/get-keyword",
                    type: "post",
                    data: form,
                    success: function (data) {
                        $(".allCreatePostItem input[name='keywordSeo']").val(data);
                        $(".autoKeyword").text('دریافت خودکار');
                    },
                    error: function (xhr) {
                        $(".autoKeyword").text('دریافت خودکار');
                    }
            ...
            if(posts.colors) {
                if(JSON.parse(posts.colors)) {
                    $.each(JSON.parse(posts.colors),function(){
                        $('#colors').append(
                            $('<tr><td><input type="text" name="name" value="'+this.name+'" placeholder="عنوان را وارد کنید"></td><td><input name="color" value="'+this.color+'" type="text" placeholder="کد را وارد کنید"></td><td><input name="count" value="'+this.count+'" placeholder="تعداد را وارد کنید"></td><td><input name="price" value="'+this.price+'" placeholder="قیمت را وارد کنید"></td><td><div><button class="choiceRelated">انتخاب تصویر</button><input type="hidden" name="myImage" value="'+this.image+'"></div></td><td><i id="deleteColor"><svg class="icon"><use xlink:href="#trash"></use></svg></i></td></tr>')
            ...
            if(posts.size) {
                if(JSON.parse(posts.size)) {
                    $.each(JSON.parse(posts.size),function(){
                        $('#sizes').append(
                            $('<tr><td><input type="text" name="name" value="'+this.name+'" placeholder="عنوان را وارد کنید"></td><td><input type="text" name="count" value="'+this.count+'" placeholder="تعداد را وارد کنید"></td><td><input placeholder="قیمت را وارد کنید" value="'+this.price+'" name="price"></td><td><div><button class="choiceRelated">انتخاب تصویر</button><input type="hidden" name="myImage" value="'+this.image+'"></div></td><td><i id="deleteSize"><svg class="icon"><use xlink:href="#trash"></use></svg></i></td></tr>')
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if(typeG == 0){
                            ...
                            $(".allCreatePostDetailItems input[name='titleEn']").val(data[0]);
            ...
            $("button[name='createPost']").click(function(event){
                ...
                var skima = $(".allCreatePostData input[name='skima']").val();
                var robots = $(".allCreatePostData select[name='robots']").val();
                var rating = $(".allCreatePostData input[name='rating']").val();
                var meta = $(".allCreatePostData textarea[name='meta']").val();
                ...
                var varName2 = $("input[name='varName2']").val();
                var varName1 = $("input[name='varName1']").val();
                ...
                $("#colors tr").each(function(){
                    if($(this).find("input").length >= 1) {
                        ...
                        $(this).find("input").each(function () {
                            ...
                            if (this.name == 'myImage') {
                                color.image = this.value;
                            }
                        })
                        colors.push(color);
                    }
            ...
            $(document).on("click",".choiceRelated",function (){
                $(".choicePic").show();
                $(".choicePic .pics").remove();
                myPic = $($(this)[0]['parentElement']).find('input');
                myA = myPic.val().split(',');
                var image1 = '';
                $(".getImagePic").each(function(){
                    var check1 = 0;
                    var im1 = this.lastElementChild.src;
                    if(myA.length >= 1){
                        myA.forEach(function (item1){
                            if(item1 == im1){
                                check1 = 1;
                            }
                        })
                    ...
                    if(check1 == 1){
                        image1 += `<div class="pics active"><img src="${im1}"/></div>`
                    }else{
                        image1 += `<div class="pics unActive"><img src="${im1}"/></div>`
                    }
                });
                $(".choicePic .allPic .data").prepend(
                    $(`${image1}`)
                )
            })
            $(document).on("click",".choicePic .pics",function (){
                if($(this).hasClass('active')){
                    $(this).attr('class','pics unActive');
                }else{
                    $(this).attr('class','pics active');
                }
            })
            $(document).on("click",".cancelPic",function (){
                $(".choicePic").hide();
                $(".choicePic .pics").remove();
            })
            $(document).on("click",".submitPic",function (){
                array1 = [];
                $(".choicePic .active").each(function (){
                    array1.push($(this).find('img').attr('src'));
                })
                myPic.val(array1.join(','));
                $(".choicePic").hide();
                $(".choicePic .pics").remove();
            })
            ...
            $('#addColor').click(function (){
                $('#colors').append(
                    $('<tr><td><input type="text" name="name" placeholder="نام را وارد کنید"></td><td><input name="color" type="color" placeholder="کد را وارد کنید"></td><td><input name="count" placeholder="تعداد را وارد کنید"></td><td><input name="price" placeholder="قیمت را وارد کنید"></td><td><div><button class="choiceRelated">انتخاب تصویر</button><input type="hidden" name="myImage"></div></td><td><i id="deleteColor"><svg class="icon"><use xlink:href="#trash"></use></svg></i></td></tr>')
                        .on('click' , '#deleteColor',function(ss){
                            ss.currentTarget.parentElement.parentElement.remove();
                        })
                );
            ...
            $('#addSize').click(function (){
                $('#sizes').append(
                    $('<tr><td><input type="text" name="name" placeholder="سایز را وارد کنید"></td><td><input type="text" name="count" placeholder="تعداد را وارد کنید"></td><td><input placeholder="قیمت را وارد کنید" name="price"></td><td><div><button class="choiceRelated">انتخاب تصویر</button><input type="hidden" name="myImage"></div></td><td><i id="deleteSize"><svg class="icon"><use xlink:href="#trash"></use></svg></i></td></tr>')
                        .on('click' , '#deleteSize',function(ss){
                            ss.currentTarget.parentElement.parentElement.remove();
                        })
                );
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myizonek/public_html/local/resources/views/admin/post/edit.blade.php ENDPATH**/ ?>