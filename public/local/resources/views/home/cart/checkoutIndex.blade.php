        ...
        <div class="checkoutItems">
            <div>
                <div class="checkoutOptions">
                    @if($physical)
                        ...
                        @if(\App\Models\Setting::where('key' , 'deliverStatus')->pluck('value')->first() == 1)
                                    ...
                                    <li>
                                        <div class="dayItem">
                                            <div class="dayUn" id="dayItem">
                                                ...
                                                @if($item['limit'] > $prices+(int)($weights*$item->weightPrice))
                    ...
                    <div class="payMethod" id="method">
                        ...
                        <ul>
                            ...
                            @endif
                            @if($installment && $prebuy == 0 && $physical)
                                <li>
            ...
            <div class="left">
                ...
                <div class="cartPay">
                    ...
                    @if($statusSnap && !empty($eligible['response']))
                        <div class="gateItem" data="snappay" id="9">
                            <img src="/img/snappay.svg" alt="snappay">
                            <div class="snapDes">
                                <h4>{{$eligible['response']['title_message']}}</h4>
                                <p>{{$eligible['response']['description']}}</p>
                            </div>
                        </div>
                    @endif
...
@section('script1')
    <script>
        $(document).ready(function(){
            ...
            var weights = {!! json_encode($weights, JSON_HEX_TAG) !!};
            var allPrices = {!! $prices !!};
            var cartPrice = {!! $cartPrice !!};
            var taxPrice = {!! $taxPrice !!};
