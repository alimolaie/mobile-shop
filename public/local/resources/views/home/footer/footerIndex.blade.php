    ...
    <div class="blockFooter width">
        <div class="topFooterIndex">
            <div class="item">
                ...
                <div>
                    <div class="title2">{{__('messages.type_footer1')}}</div>
                    <div class="title3">{{__('messages.status_footer1')}}</div>
                </div>
            </div>
            <div class="item">
                <div class="itemPic">
                ...
                <div>
                    <div class="title2">{{__('messages.type_footer2')}}</div>
                    <div class="title3">{{__('messages.status_footer2')}}</div>
                </div>
            </div>
            <div class="item">
                <div class="itemPic">
                ...
                <div>
                    <div class="title2">{{__('messages.type_footer3')}}</div>
                    <div class="title3">{{__('messages.status_footer3')}}</div>
                </div>
            </div>
            <div class="item">
                <div class="itemPic">
                ...
                <div>
                    <div class="title2">{{__('messages.type_footer4')}}</div>
                    <div class="title3">{{__('messages.status_footer4')}}</div>
                </div>
            </div>
        </div>
        <div class="midFooter">
            <div class="items">
                <div class="title3">{{__('messages.fast1')}}</div>
                <ul>
            ...
            <div class="items">
                <div class="title3">{{__('messages.trust1')}}</div>
