...
@section('content')
    <main class="allCompare width">
        <h1 class="titleCompare">{{__('messages.compare_product')}}</h1>
        <div class="compareItems">
            <div class="compareItem" id="compare1">
                <div class="addCompare">
                    ...
                    <div class="title2">{{__('messages.add_product1')}}</div>
                </div>
            </div>
        ...
        <div class="compareTable" style="display:none;">
            <table>
                <tr>
                    <td>
                        <div class="title2">{{__('messages.price1')}}</div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <div class="title2">{{__('messages.count1')}}</div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <div class="title2">{{__('messages.off')}}</div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <div class="title2">{{__('messages.score')}}</div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <div class="title2">{{__('messages.property')}}</div>
                    </td>
                </tr>
        ...
        <div class="showAllProducts" style="display:none;">
            <div class="productItems">
                <div class="showProductTitle">
                    <div class="title2">{{__('messages.search_product')}}</div>
                    <i>
                        <svg class="icon">
            ...
            if(product){
                ...
                $.each(JSON.parse(product.ability) , function(){
                    $(".compareTable .abilityCompare " + '#'+compareId).append(
                        $('<div class="price1">+ '+this.name+'</div>')
                    )
                })
            }
            $(document).on('click','.allProducts .productItem',function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(".compareTable .abilityCompare " + '#'+compareId).children(".price1").remove();
                            ...
                            $.each(data,function(){
                                $('.allProducts').append(
                                    '<div class="productItem" id="'+this.id+'">'+
                                        ...
                                        '<div class="price1">'+makePrice(this.price)+arz1+' </div>'+
                                    '</div>'
                                );
                            })
                        },
