...
@section('content')
    <main class="allIndex">
        ...
        @foreach($widget as $item)
            ...
            @endif
            @if($item['name'] == 'بنر با عنوان')
                <div class="indexData">
                    @include('home.index.adIndex2' , ['data' => $item])
                </div>
            @endif
            @if($item['name'] == 'وام')
                <div class="indexData">
            ...
            @endif
            @if($item['name'] == 'محصول تصویر چپ' && count($item['post']) >= 1)
                <div class="indexData">
                    @include('home.index.productList2' , ['data' => $item])
                </div>
            @endif
            @if($item['name'] == 'محصول تصویر بالا' && count($item['post']) >= 1)
                <div class="indexData">
                    @include('home.index.productList3' , ['data' => $item])
                </div>
            @endif
            @if($item['name'] == 'محصولات با فیلتر')
                <div class="indexData">
                    @include('home.index.filterProduct' , ['data' => $item])
                </div>
            @endif
            @if($item['name'] == 'محصولات افقی با دسته بندی')
                <div class="indexData">
                    @include('home.index.horizonProduct' , ['data' => $item])
                </div>
            @endif
            ...
            @if($item['name'] == 'دسته بندی 2')
                <div class="indexData">
                    @include('home.index.allCategory' , ['data' => $item])
                </div>
            @endif
            @if($item['name'] == 'درباره ما')
                <div class="indexData">
                    @include('home.index.aboutIndex' , ['data' => $item])
                </div>
            @endif
            ...
            @if($item['name'] == 'خبر2')
                <div class="indexData">
                    @include('home.index.newsIndex2' , ['data' => $item])
                </div>
            @endif
        @endforeach
        <h2 class="hiddenSeo">{{$title1}}</h2>
        @if($popUp == 1)
        ...
        @endif
        @if(\App\Models\Setting::where('key' , 'preLoaderStatus')->pluck('value')->first())
            @include('home.splash')
        @endif
    </main>
@endsection
