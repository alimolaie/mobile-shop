...
@section('content')
    <div class="allManageSetting">
        ...
        <form method="post" action="/admin/setting/payment" class="settingMangeItems">
            ...
            <div class="settingItem">
                <label>نام کاربری اسنپ پی</label>
                <input type="text" name="userSnap" value="{{$userSnap}}" placeholder="ترمینال آیدی را وارد کنید">
            </div>
            <div class="settingItem">
                <label>رمز اسنپ پی</label>
                <input type="text" name="passwordSnap" value="{{$passwordSnap}}" placeholder="ترمینال آیدی را وارد کنید">
            </div>
            <div class="settingItem">
                <label>client_id اسنپ پی</label>
                <input type="text" name="idSnap" value="{{$idSnap}}" placeholder="ترمینال آیدی را وارد کنید">
            </div>
            <div class="settingItem">
                <label>client_secret اسنپ پی</label>
                <input type="text" name="secretSnap" value="{{$secretSnap}}" placeholder="ترمینال آیدی را وارد کنید">
            </div>
            <div class="settingItem">
                ...
                <select name="choicePay">
                    ...
                    <option value="6">آسان پرداخت</option>
                </select>
            </div>
            <div class="settingItem">
            ...
            <div class="allCreatePostDetailItem">
                ...
                <label for="statusSnap1" class="allCreatePostDetailItemData">
                    امکان خرید از اسنپ پی
                    <input id="statusSnap1" type="checkbox" name="statusSnap" class="switch" >
                </label>
            </div>
...
@section('scripts3')
    <script>
        $(document).ready(function(){
            ...
            var statusSnap = {!! json_encode($statusSnap, JSON_HEX_TAG) !!};
            ...
            if(statusSnap == 1){
                $("input[name='statusSnap']").prop("checked", true );
            }
        })
    </script>
@endsection
