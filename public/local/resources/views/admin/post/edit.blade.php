            ...
            <div id="infoProduct" class="allCreatePostData">
                <div class="allCreatePostSubject">
                    ...
                    <div class="abilityPost type1">
                        <div class="abilityTitle">
                            <input type="text" name="varName1" value="{{$posts->varName1}}" placeholder="مثال : رنگ">
                            <i id="addColor">
                                <svg class="icon">
                                    <use xlink:href="#add"></use>
                                </svg>
                    ...
                    <div class="abilityPost type1">
                        <div class="abilityTitle">
                            <input type="text" name="varName2" value="{{$posts->varName2}}" placeholder="مثال : رنگ">
                            <i id="addSize">
                                <svg class="icon">
                                    <use xlink:href="#add"></use>
                                </svg>
            ...
            <div id="seoProduct" class="allCreatePostData" style="display: none">
                <div class="allCreatePostSubject">
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" name="titleSeo" value="{{$posts->titleSeo}}" placeholder="عنوان را وارد کنید">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <div class="detailPrices">
                            <input type="text" name="keywordSeo" value="{{$posts->keywordSeo}}" placeholder="با , جدا کنید">
                            <button class="autoKeyword">دریافت خودکار</button>
                        </div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>alt تصویر* :</label>
                        <input type="text" name="imageAlt" value="{{$posts->imageAlt}}" placeholder="عنوان را وارد کنید">
                        <div id="validation-imageAlt"></div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>کد اسکیما :</label>
                        <input type="text" name="skima" value="{{$posts->skima}}" placeholder="کد اسکیما را وارد کنید">
                    ...
                    <div class="allCreatePostItem">
                        ...
                        <input type="text" value="{{$posts->rating}}" name="rating" placeholder="کد را وارد کنید">
                        <div id="validation-rating"></div>
                    </div>
                    <div class="allCreatePostItem">
                        <label>متاتگ های بیشتر :</label>
                        <textarea name="meta" placeholder="متاتگ را وارد کنید">{{$posts->meta}}</textarea>
